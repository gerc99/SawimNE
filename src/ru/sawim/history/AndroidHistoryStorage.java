...
public class AndroidHistoryStorage {
    ...
    public void addText(String text, boolean incoming,
        ...
        ru.sawim.modules.fs.JSR75FileSystem fs = getFile();
        try {
    ...
    private ru.sawim.modules.fs.JSR75FileSystem getFile() {
        return HomeDirectory.getFile(ru.sawim.modules.fs.FileSystem.HISTORY + "/" + historyStorage.getUniqueUserId() + ".txt");
    }
    ...
    private byte[] readLast(ru.sawim.modules.fs.JSR75FileSystem fs, int read) throws Exception {
