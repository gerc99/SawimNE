 ...
 */
public class TextLinkClickListener implements MyTextView.TextLinkClickListener {

    private Protocol currentProtocol;
    private String currentContact;

    public TextLinkClickListener(Protocol currentProtocol, String currentContact) {
